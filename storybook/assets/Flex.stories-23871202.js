import{j as s}from"./jsx-runtime-ffb262ed.js";import{s as me,n as ge}from"./styled-components.browser.esm-7e430b1e.js";import{F as a}from"./Flex-11ba1f9c.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";const pe=me.div.withConfig({displayName:"Flexstories__Item",componentId:"sc-wng4hw-0"})(["width:100px;height:45px;border-radius:4px;display:flex;justify-content:center;align-items:center;&::before{content:'Item';}",""],({theme:e})=>ge(["background-color:",";color:",";font-size:",";"],e.color.primary[500],e.color.gray[50],e.typography.size[200])),Fe={title:"Components/Common/Flex",component:a,tags:["autodocs"],argTypes:{children:{table:{disable:!0}},className:{table:{disable:!0}},style:{table:{disable:!0}}},parameters:{componentSubtitle:"Flex 컴포넌트",docs:{description:{component:"`display: flex` 속성을 지원하는 컴포넌트로 레이아웃 구성을 쉽게 할 수 있는 컴포넌트입니다."}}}},r={args:{children:Array.from({length:4}).map((e,g)=>s.jsx(pe,{},g)),$gap:8}},t={...r,render:e=>s.jsx(a,{...e,tag:"main"})},o={...r,render:e=>s.jsx(a,{...e,$justifyContent:"center"})},n={...r,render:e=>s.jsx(a,{...e,$alignItems:"center",$height:200})},c={...r,render:e=>s.jsx(a,{...e,$direction:"column"})},i={...r,render:e=>s.jsx(a,{...e,$gap:20})},d={...r,render:e=>s.jsx(a,{...e,$flexGrow:"1"})},p={...r,decorators:[e=>s.jsx("div",{style:{width:"240px"},children:s.jsx(e,{})})],render:e=>s.jsx(a,{...e,$flexWrap:"wrap"})},l={...r,render:e=>s.jsx(a,{...e,$fullWidth:!0,style:{background:"#eaeaea"},children:Array.from({length:8}).map((g,le)=>s.jsx(pe,{},le))})},m={...r,render:e=>s.jsx(a,{...e,$width:600,$height:200,style:{background:"#eaeaea"}})};var u,x,f,y,h;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    children: Array.from({
      length: 4
    }).map((_, i) => <Item key={i} />),
...
//# sourceMappingURL=Flex.stories-23871202.js.map
